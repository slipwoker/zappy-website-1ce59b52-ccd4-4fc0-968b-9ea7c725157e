document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      // Skip disabled, hidden, or non-input elements
      ...
      // Tel validation
      if (field.type === 'tel' && !VALIDATORS.tel(value)) {
    ...
    // Real-time validation on blur using event delegation
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גליל טכנולוגיות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1ce59b52-ccd4-4fc0-968b-9ea7c725157e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1ce59b52-ccd4-4fc0-968b-9ea7c725157e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1ce59b52-ccd4-4fc0-968b-9ea7c725157e';
